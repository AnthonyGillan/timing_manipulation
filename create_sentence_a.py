...
def main(argv):
	...
	try:                                                   # runs in entirety unless exception
		opts, args = getopt.getopt(argv,"hb:e:d:t:", ["sfile=", "stretch=", "dev=", "targetword=" ])
		...
		print 'create_sentence.py -b <start sentence num> -e <end sentence num> -d <deviation factor for words other than target> -t <target word number>' 
	...
	for sentence_file in range(start_file, stop_file+1):
		...
		s = Sentence(str(sentence_file), deviation_factor)       	# create a Sentence object s
